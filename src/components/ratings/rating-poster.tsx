    ...
    >
      <div className="relative">
        <Poster
          ...
          ratio="portrait"
          lazy
          className="rounded-[10px] ring-1 ring-edge-soft transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0.24,1)] motion-safe:group-hover:-translate-y-1"
        />
